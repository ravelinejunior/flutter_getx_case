import 'dart:convert';
import 'package:flutter_getx_case/controller/detail_controller.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    int _currentIndex = 0;
    final itemInfo = Get.arguments['info'];
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 40,
                        backgroundImage: AssetImage(detail['img']),
                      ),
                      SizedBox(
                        width: 10,
                      ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: IconButton(
                        onPressed: () => detailController.favCounter(),
